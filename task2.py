...
def find_fartherst_orbit(planets: list):
...
all_planets = find_fartherst_orbit(planets)
max_planet = all_planets[0]
for max_p in all_planets:
    if max_p[1][1] > max_planet[1][1]:
        max_planet = max_p
print(f'Самая большая планета с индексами {max_planet[1][0]}, Массой {max_planet[1][1]} и осями:{max_planet[0]}')